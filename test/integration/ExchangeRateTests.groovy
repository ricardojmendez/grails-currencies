...
class ExchangeRateTests extends GroovyTestCase {
    ...
    void setUp() {
        ...
        new ExchangeRate(baseCurrency:euro, toCurrency:'USD', rate:1.46122, dateCreated:new Date(2007, 12, 2)).save()
        new ExchangeRate(baseCurrency:yen, toCurrency:dollar, rate:0.008981, dateCreated:new Date(2007, 12, 2)).save()
        new ExchangeRate(baseCurrency:'USD', toCurrency:yen, rate:111.336, dateCreated:new Date(2007, 12, 2)).save()
